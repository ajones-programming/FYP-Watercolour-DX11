...
Object::Object(ID3D11Device* device, std::string path) {
	objl::Loader loader;
...
void Object::Draw(ID3D11DeviceContext* context, const XMFLOAT4X4& worldPos, const XMMATRIX& view, const XMMATRIX& proj))
{
